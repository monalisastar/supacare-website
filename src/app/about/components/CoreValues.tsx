...
export default function CoreValues() {
  return (
    <section
      id="core-values"
      className="relative bg-green-50 px-6 md:px-20"
      style={{
        marginTop: 0, // ✅ touch OurStory
    ...
    >
      <motion.div
        ...
        className="max-w-4xl mx-auto text-center mb-14 pt-16 md:pt-20" // ✅ internal spacing starts lower down
      >
