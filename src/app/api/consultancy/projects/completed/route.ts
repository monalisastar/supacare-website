...
export async function GET(req: Request) {
  try {
    ...
    // 🔹 Role-based filter
    let where: Record<string, any> = { status: "COMPLETED" }
    ...
    // ADMIN → sees all completed projects
    ...
    // 🔹 DB-level sorting (safe fields only)
    ...
    console.error("Completed Projects API Error:", error)
    return NextResponse.json(
