...
// 🛒 Floating Cart Widget + Provider
import CartWidget from '@/components/CartWidget'
import CartProvider from '@/lib/CartContext' // ✅ fixed import (default import)
...
const navLinks = [
  ...
  { name: 'Shop', href: '/dashboard/client/shop' },
    ...
    <CartProvider>
      <div className="min-h-screen flex bg-gradient-to-br from-white via-green-50 to-emerald-100 text-gray-800 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-h-screen">
          ...
          {/* 🛒 Floating Cart inside Client Dashboard (auto-hides on sidebar open) */}
          {!sidebarOpen && <CartWidget />}
        </div>
      </div>
    </CartProvider>
  )
