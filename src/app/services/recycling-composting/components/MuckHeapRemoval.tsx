      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center mb-12 gap-8">
          <div className="md:w-1/2 relative h-64 rounded-lg overflow-hidden shadow-lg">
            <Image
              src="/images/recycling and composting/Muck Heap Removal.webp" // ✅ Updated
        ...
        <div className="flex flex-col md:flex-row-reverse items-center mb-12 gap-8">
          <div className="md:w-1/2 relative h-64 rounded-lg overflow-hidden shadow-lg">
            <Image
              src="/images/recycling and composting/muck heaps delivery.webp" // ✅ Updated
        ...
        <div className="flex flex-col md:flex-row items-center mb-12 gap-8">
          <div className="md:w-1/2 relative h-64 rounded-lg overflow-hidden shadow-lg">
            <Image
              src="/images/recycling and composting/muck heap benefits.webp" // ✅ Updated
