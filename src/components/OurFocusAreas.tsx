...
export default function OurFocusAreas() {
  return (
    <section
      id="focus-areas"
      className="relative pt-10 pb-6 bg-gradient-to-b from-green-50 to-[#eaf7ec] overflow-visible"
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.h2
          ...
          className="text-4xl font-bold text-yellow-500 mb-8 text-left"
        >
          Our Core Areas
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {focusAreas.map((area, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-green-100 flex flex-col justify-between"
            >
              {/* Image */}
