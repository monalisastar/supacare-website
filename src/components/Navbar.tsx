...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // Optional: listen to resize in case announcement content wraps
  ...
  return (
    <>
      ...
      <header
        ...
        className={`fixed w-full z-50 transition-all ${isScrolled ? 'bg-[#F4B940] border-b border-orange-200/40' : 'bg-[#F4B940]'}`}
      >
