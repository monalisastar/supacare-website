...
export default function SustainabilityActions() {
  const actions = [
    ...
    },
    {
      ...
      button: 'Buy Compost',
      href: '/shop/compost', // or /services/recycling-composting
    },
    {
      ...
      href: '/contact', // or /consultancy
    },
  ]

  return (
    <section className="-mt-44 lg:-mt-48 relative z-10 bg-gradient-to-b from-transparent via-white/90 to-green-50 py-16 px-6 lg:px-12 backdrop-blur-sm">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {actions.map((item, index) => (
          ...
          >
            ...
            <Link
              href={item.href}
              className="inline-block border border-green-700 text-green-700 hover:bg-green-700 hover:text-white transition-all duration-300 px-6 py-2.5 rounded-full font-medium tracking-wide"
            >
              {item.button}
            </Link>
          </motion.div>
